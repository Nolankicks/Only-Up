...
public sealed class NetworkManager : Component, Component.INetworkListener
{
	...
	public List<PlayerController2> Players => GameManager.ActiveScene.Components.GetAll<PlayerController2>(FindMode.EnabledInSelfAndDescendants).ToList();
	...
	public async void SpawnPlayer(Connection channel)
	{
		...
		var playerController = player.Components.Get<PlayerController2>(FindMode.EverythingInSelfAndDescendants);
